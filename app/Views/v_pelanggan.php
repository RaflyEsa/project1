...
id="addDataModalLabel">Tambah Pelanggan</h5>
...
id="nama" name="nama_pelanggan" required>
                             </div>
                             <div class="mb-3">
                                 <label for="alamat"
class="form-label">Alamat</label>
                                 <input type="text" class="form-control"
id="alamat" name="alamat_pelanggan" required>
                             </div>
                             <div class="mb-3">
                                 <label for="no_telp"
                 ...
                 <?php if (!empty($pelanggan)) : ?>
                     <?php foreach ($pelanggan as $row) : ?>
                         <tr>
                             ...
                             <td><?= $row['no_telp'] ?></td>
                             <td>
                                 <a href="/pelanggan/edit/<?=
$row['id_pelanggan'] ?>" class="btn btn-warning btn-sm">Edit</a>
                                 <a href="/pelanggan/delete/<?=
$row['id_pelanggan'] ?>" class="btn btn-danger btn-sm" onclick="return
